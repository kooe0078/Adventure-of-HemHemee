...
public class FirstBossSoundManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dragonCtrl = GameObject.Find("Polygonal Dragon Red").GetComponent<DragonCtrl>();
    }
    ...
    {
        // 보스몬스터 생존시 BGM 재생
        if (dragonCtrl.isDie == false && oneTime == true)
        {
        ...
        // 보스몬스터 사망시 다른 BGM 재생
        else if (dragonCtrl.isDie == true && oneTime == false)
        {
